        ...
        <div className={styles.container}>
            ...
            <div className={styles.wrap}>
                <div className={styles.search}>
                    <input  onKeyDown={e=>search(e,"pressed enter")} type="text" name="search" className={styles.searchTerm} placeholder="What are you looking for?" onChange={e=>setKeyword(e.target.value)}/>
